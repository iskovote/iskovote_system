...
<div class="right_col" role="main">
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapse2">Vice President Internal</a>
      </h4>
    </div>
    <div id="collapse2" class="panel-collapse collapse">
      <div class="panel-body"> <div id="collapse2" class="panel-collapse collapse in">
        <div class="panel-body">  <div class="column4one">
          <label style="font-size: 15px; padding-left: 40px;"> Candidate #1 </label>
          <div style="padding-right: 350px; padding-left: 50px;  position: absolute;">
            <!-- <img src ="images/userDefault.png" style="width: 280px; height: 250px;"> -->
            <div class = "Position2" style=" padding-right: 220px;">
              <form style="border-bottom: 0px ">
               <div class="container">
                <div class="row">
                  <div class="column">
                    <div class="upload-btn-wrapper">
                      <img src = "" style="display:none; background-size: cover;" height="260" width="260" id = "vicepresIn" border="10">
                      <button class="btn">Upload Photo</button>
                      <input type="file" onchange="vicepresInImageC1.call(this)"/>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              <div class="column">
                <div class="upload-btn-wrapper">
                  <img src = "" style="display:none; background-size: cover;" height="260" width="260" id = "vicepresIn" border="10">
                  <button class="btn">Upload Photo</button>
                  <input type="file" onchange="vicepresInImageC2.call(this)"/>
                </div>
              </div>
            </div>
          </div>
...
<div class="panel panel-default">
  <div class="panel-heading">
    <h4 class="panel-title">
      <a data-toggle="collapse" data-parent="#accordion" href="#collapse3">Vice President External</a>
    </h4>
  </div>
  <div id="collapse3" class="panel-collapse collapse">
    <div class="panel-body"> <div id="collapse3" class="panel-collapse collapse in">
      <div class="panel-body">  <div class="column4one">
        <label style="font-size: 15px; padding-left: 40px;"> Candidate #1 </label>
        <div style="padding-right: 350px; padding-left: 50px;  position: absolute;">
          <!-- <img src ="images/userDefault.png" style="width: 280px; height: 250px;"> -->
          <div class = "Position3" style=" padding-right: 220px;">
            <form style="border-bottom: 0px ">
             <div class="container">
              <div class="row">
                <div class="column">
                  <div class="upload-btn-wrapper">
                    <img src = "" style="display:none; background-size: cover;" height="260" width="260" id = "vicepresExC1" border="10">
                    <button class="btn">Upload Photo</button>
                    <input type="file" onchange="vicepresExImage.call(this)"/>
                  </div>
                </div>
              </div>
            </div>
        ...
        <form style="border-bottom: 0px ">
         <div class="container">
          <div class="row">
            <div class="column">
              <div class="upload-btn-wrapper">
                <img src = "" style="display:none; background-size: cover;" height="260" width="260" id = "vicepresExC2" border="10">
                <button class="btn">Upload Photo</button>
                <input type="file" onchange="vicepresExImageC2.call(this)"/>
              </div>
            </div>
          </div>
        </div>
...
<div class="panel panel-default">
  <div class="panel-heading">
    <h4 class="panel-title">
      <a data-toggle="collapse" data-parent="#accordion" href="#collapse4">Secretary</a>
    </h4>
  </div>
  <div id="collapse4" class="panel-collapse collapse">
    <div class="panel-body"> <div id="collapse4" class="panel-collapse collapse in">
      <div class="panel-body">  <div class="column4one">
        <label style="font-size: 15px; padding-left: 40px;"> Candidate #1 </label>
        <div style="padding-right: 350px; padding-left: 50px;  position: absolute;">
          <!-- <img src ="images/userDefault.png" style="width: 280px; height: 250px;"> -->
          <div class = "Position4" style=" padding-right: 220px;">
            <form style="border-bottom: 0px ">
             <div class="container">
              <div class="row">
                <div class="column">
                  <div class="upload-btn-wrapper">
                    <img src = "" style="display:none; background-size: cover;" height="260" width="260" id = "secretC1" border="10">
                    <button class="btn">Upload Photo</button>
                    <input type="file" onchange="secImageC1.call(this)"/>
                  </div>
                </div>
              </div>
            </div>
        ...
        <form style="border-bottom: 0px ">
         <div class="container">
          <div class="row">
            <div class="column">
              <div class="upload-btn-wrapper">
                <img src = "" style="display:none; background-size: cover;" height="260" width="260" id = "secretC2" border="10">
                <button class="btn">Upload Photo</button>
                <input type="file" onchange="secImageC2.call(this)"/>
              </div>
            </div>
          </div>
        </div>
...
<div class="panel panel-default"> 
  <div class="panel-heading">
    <h4 class="panel-title">
      <a data-toggle="collapse" data-parent="#accordion" href="#collapse5">Assistant Secretary</a>
    </h4>
  </div>
  <div id="collapse5" class="panel-collapse collapse">
    <div class="panel-body"> <div id="collapse5" class="panel-collapse collapse in">
      <div class="panel-body">  <div class="column4one">
        <label style="font-size: 15px; padding-left: 40px;"> Candidate #1 </label>
        <div style="padding-right: 350px; padding-left: 50px;  position: absolute;">
          <!-- img src ="build/images/userDefault.png" style="width: 280px; height: 250px;"> -->
          <div class = "Position5" style=" padding-right: 220px;">
            <form style="border-bottom: 0px ">
             <div class="container">
              <div class="row">
                <div class="column">
                  <div class="upload-btn-wrapper">
                    <img src = "" style="display:none; background-size: cover;" height="260" width="260" id = "assistsecretC1" border="10">
                    <button class="btn">Upload Photo</button>
                    <input type="file" onchange="assistsecImageC1.call(this)"/>
                  </div>
                </div>
              </div>
            </div>
        ...
        <form style="border-bottom: 0px ">
         <div class="container">
          <div class="row">
            <div class="column">
              <div class="upload-btn-wrapper">
                <img src = "" style="display:none; background-size: cover;" height="260" width="260" id = "assistsecretC2" border="10">
                <button class="btn">Upload Photo</button>
                <input type="file" onchange="assistsecImageC2.call(this)"/>
              </div>
            </div>
          </div>
        </div>
...
<div class="panel panel-default">
  <div class="panel-heading">
    <h4 class="panel-title">
      <a data-toggle="collapse" data-parent="#accordion" href="#collapse6">Treasurer</a>
    </h4>
  </div>
  <div id="collapse6" class="panel-collapse collapse">
    <div class="panel-body"> <div id="collapse6" class="panel-collapse collapse in">
      <div class="panel-body">  <div class="column4one">
        <label style="font-size: 15px; padding-left: 40px;"> Candidate #1 </label>
        <div style="padding-right: 350px; padding-left: 50px;  position: absolute;">
          <!-- <img src ="images/userDefault.png" style="width: 280px; height: 250px;"> -->
          <div class = "Position6" style=" padding-right: 220px;">
            <form style="border-bottom: 0px ">
             <div class="container">
              <div class="row">
                <div class="column">
                  <div class="upload-btn-wrapper">
                    <img src = "" style="display:none; background-size: cover;" height="260" width="260" id = "treasuC1" border="10">
                    <button class="btn">Upload Photo</button>
                    <input type="file" onchange="treasurerImageC1.call(this)"/>
                  </div>
                </div>
              </div>
            </div>
        ...
        <form style="border-bottom: 0px ">
         <div class="container">
          <div class="row">
            <div class="column">
              <div class="upload-btn-wrapper">
                <img src = "" style="display:none; background-size: cover;" height="260" width="260" id = "treasuC2" border="10">
                <button class="btn">Upload Photo</button>
                <input type="file" onchange="treasurerImageC2.call(this)"/>
              </div>
            </div>
          </div>
        </div>
