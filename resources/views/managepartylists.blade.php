        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <br/><br/>
              ...
              <button id="delete_position" data-toggle="modal" data-target="#deletePosition" class="btn btn-danger" style="float: right;">Delete Partylist</button>
              <button id="edit_position" data-toggle="modal" data-target="#editPosition" class="btn btn-primary" style="float: right;">Edit Partylist</button>
              <button id="add_position" data-toggle="modal" data-target="#addPosition" class="btn btn-success" style="float: right;">Add Partylist</button>
